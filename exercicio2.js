...
function rotate(direction) {
  ...
  return function () {
    ...
    slide.src = `${servidorDasImagens}/${imagens[position].arquivo}`
    slide.alt = imagens[position].descricao
  }
}

document.getElementById('anterior').addEventListener('click', rotate('anticlockwise'))
document.getElementById('proximo').addEventListener('click', rotate('clockwise'))
